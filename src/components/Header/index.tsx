            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                ...
                <li className="py-4">
                  ...
                  >
                    <path
                      d="M8 14.35l-0.88-0.8C3.2 10.36 1 8.28 1 5.92 1 4.02 2.52 2.5 4.42 2.5c0.99 0 1.94 0.46 2.58 1.19C7.99 2.96 8.94 2.5 9.92 2.5c1.9 0 3.42 1.52 3.42 3.42 0 2.36-2.2 4.44-6.12 7.63L8 14.35z"
                      fill={wishlistCount > 0 ? "#f17272ff" : "#D1D5DB"}
                    />
                  </svg>
                    Wishlist
                  </Link>
